  ...
  <el-card class="box-card">
    ...
    <el-table style="margin: 10px 0;" border :data="trademarkArr">
      ...
      <el-table-column label="品牌LOGO">
        <template #="{ row, $index }">
          <img :src="row.logoUrl" alt="" width="100" height="100">r 
        </template>
      </el-table-column>
      <el-table-column label="品牌操作">
        <template #="{ row, $index }">
          <el-button type="primary" size="small" @click="" icon="Edit"></el-button>
          <el-button type="primary" size="small" @click="" icon="Deletes"></el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-pagination v-model:current-page="pageNo" v-model:page-size="limit" :page-sizes="[3, 5, 7, 9]" :small="false"
      :background="true" layout="prev, pager, next, jumper, -> , sizes, total" :total="total" @size-change=""
      @current-change="" />
