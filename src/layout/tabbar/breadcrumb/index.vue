<template>
    <div class="breadcrumb">
        ...
        <el-breadcrumb separator-icon="arrowRight">
            ...
            <el-breadcrumb-item v-for="(item, index) in $route.matched" :key="index" v-show="item.meta.isVisiable"
                :to="item.path">
                <!-- 路由图标 -->
                <el-icon>
                ...
                <!-- 路由标题 -->
                <span style="margin: 0 3px; vertical-align: middle;">{{ item.meta.title }}</span>
            </el-breadcrumb-item>
        </el-breadcrumb>
    </div>
</template>
